...
with DAG(
    ...
    get_links = DockerOperator(
        ...
        command='--output_folder_path /opt/airflow/data/links/ --current_date {{ ds }}',
        network_mode="host",
    ...
    extract_law_data = DockerOperator(
        ...
        command='--raw_law_links_path /opt/airflow/data/links/ --output_file /opt/airflow/data/law_jsons/{{ ds }}.json',
        network_mode="host",
